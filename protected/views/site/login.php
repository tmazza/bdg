<div class="" style="max-width:400px;margin:0 auto;">
  <div class="uk-align-center" style="width:230px;">
    ...
    <?= CHtml::link('Entar usando email', '#!',array('class'=>'uk-button uk-button-link','style'=>'width:100%','onclick'=>'$(this).next().slideToggle()')); ?>
    <div style="display:none;">
      ...
      <br>
      <br>
      <?php echo CHtml::submitButton('Entrar', array('class' => 'uk-button uk-button-primary','tabindex'=>3)); ?>
      <?php $this->endWidget(); ?>
    </div>
  </div>
</div>
